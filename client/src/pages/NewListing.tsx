...
/**
 * Render the new listing creation page with a multi-section form, photo batch upload UI, and submission handling.
 *
 * The page includes sections for general info, address, cost, availability dates, listing details, features,
 * photo management (drag-and-drop, batch processing, main photo selection, removal), validation for minimum photos,
 * and a submit flow that creates the listing and uploads ordered photos.
 *
 * @returns The component's JSX element: a form-driven page for creating a listing with photo management and navigation on success.
 */
